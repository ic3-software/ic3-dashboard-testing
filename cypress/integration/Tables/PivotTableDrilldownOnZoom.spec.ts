...
describe("Tables/Pivot Table Drilldown on Zoom", () => {
    ...
    it("zoom expanded", () => {
        ...
        // Same as 'zoom' but before opening the zoom

        cy.getWidget(widgetId).find(".ic3WidgetBox-content .ic3-pt-rows .ic3-pt-row")
            .should("have.length", 5)
        cy.getWidget(widgetId).find(`.ic3WidgetBox-content .ic3-pt-left-header div[data-vr='1'][data-vc='0'] svg`)
            .click()
        cy.getWidget(widgetId).find(".ic3WidgetBox-content .ic3-pt-rows .ic3-pt-row")
            .should("have.length", 5 + 4)
        cy.getWidget(widgetId).find(`.ic3WidgetBox-content .ic3-pt-left-header div[data-vr='3'][data-vc='0'] svg`)
            .click()
        cy.getWidget(widgetId).find(".ic3WidgetBox-content .ic3-pt-rows .ic3-pt-row")
            .should("have.length", 5 + 4 + 3)
